...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://w:w@cluster0.u9i318i.mongodb.net/?retryWrites=true&w=majority")
...
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001694632094))
